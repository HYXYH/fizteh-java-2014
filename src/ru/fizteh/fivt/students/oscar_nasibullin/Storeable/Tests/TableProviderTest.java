...
public class TableProviderTest {
    ...
    public void testGetTableNames() throws Exception {
        ...
        provider.createTable("table3", types);
        List<String> trueResult = new ArrayList<>(Arrays.asList(new String[]{"table1", "table2", "table3"}));
    ...
    public void testCreateTable() throws Exception {
        ...
        assertEquals(null, provider.createTable("table", types));
    }
